...
impl From<FullStatisticsMap> for StatisticsMapInfo {
    fn from(full_stats: FullStatisticsMap) -> StatisticsMapInfo {
        ...
        StatisticsMapInfo {
            ...
            binary_op_bit_xor: get_counter_value(&map.bin_op_counter, &BinaryOp::BitXor),
            binary_op_bit_and: get_counter_value(&map.bin_op_counter, &BinaryOp::BitAnd),
            binary_op_bit_or: get_counter_value(&map.bin_op_counter, &BinaryOp::BitOr),
