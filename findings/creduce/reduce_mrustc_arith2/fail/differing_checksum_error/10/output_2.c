...
void  ZRG1cD3bin4main0g(void)
{
	...
	t_ZRTA1G2cE9core0_0_03fmt10ArgumentV10g *var6;	// &[::"core-0_0_0"::fmt::ArgumentV1/*S*/; 1]
	tUNIT var7 = {0};	// ()
	struct s_ZRG2cE9core0_0_03fmt9Arguments0g var8;	// ::"core-0_0_0"::fmt::Arguments/*S*/
	struct e_ZRG2cE9core0_0_06option6Option1gBsSG4c_A3fmt2rt2v18Argument0g var9;	// ::"core-0_0_0"::option::Option<&[::"core-0_0_0"::fmt::rt::v1::Argument/*S*/],>/*E*/
	SLICE_PTR var10;	// &[&str]
	SLICE_PTR var11;	// &[::"core-0_0_0"::fmt::ArgumentV1/*S*/]
	var1 = make128s_raw(18446744073709551615ull, 18446744073709551611ull);	// _1 = Constant(-5 i128)
	add128s_o(make128s_raw(0ull, 0ull), make128s_raw(0ull, 5ull), &var2);
	// ^ Call( _2 = "overflowing_add"::<i128,>( +0 i128, +5 i128, ), bb1, bb4)
	var0 = div128s(var1, var2);	// _0 = BinOp(_1 DIV _2)
	var3 = & var0;	// _3 = Borrow(Shared, _0)
	var10 = make_sliceptr(&ZRG2cD3binB_09FRAGMENTS0g.val, 0x2ull);	// _10 = MakeDst(&::"bin#"::#0::FRAGMENTS, 0x2 usize)
	var4 = ZRIG2cE9core0_0_03fmt10ArgumentV10g3new1gCj( var3, ZRQCj2cE9core0_0_03fmt7Display0g_B0g );
	// ^ Call( _4 = <::"core-0_0_0"::fmt::ArgumentV1/*S*/ /*- */>::new<i128,>( _3, &<i128 as ::"core-0_0_0"::fmt::Display>::fmt, ), bb2, bb4)
	var5.DATA[0] = var4;	// _5 = Array(_4)
	var6 = & var5;	// _6 = Borrow(Shared, _5)
	var11 = make_sliceptr(var6, 0x1ull);	// _11 = MakeDst(_6, 0x1 usize)
	memset(&var9, 0, sizeof(struct e_ZRG2cE9core0_0_06option6Option1gBsSG4c_A3fmt2rt2v18Argument0g ));	// _9 = Variant(::"core-0_0_0"::option::Option<&[::"core-0_0_0"::fmt::rt::v1::Argument/*S*/],> #0, {})
	var8._0 = var10;
	var8._1 = var9;
	var8._2 = var11;	// _8 = Struct(::"core-0_0_0"::fmt::Arguments, {_10, _9, _11})
	ZRG3cD8std0_0_02io5stdio6_print0g( var8 );
	// ^ Call( _7 = ::"std-0_0_0"::io::stdio::_print( _8, ), bb3, bb4)
	/* ZST assign */
	return ;
	// ^ Return
