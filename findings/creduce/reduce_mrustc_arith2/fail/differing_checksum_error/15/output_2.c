...
void  ZRG1cD3bin4main0g(void)
{
	...
	tUNIT var5 = {0};	// ()
	struct s_ZRG2cE9core0_0_03fmt9Arguments0g var6;	// ::"core-0_0_0"::fmt::Arguments/*S*/
	struct e_ZRG2cE9core0_0_06option6Option1gBsSG4c_A3fmt2rt2v18Argument0g var7;	// ::"core-0_0_0"::option::Option<&[::"core-0_0_0"::fmt::rt::v1::Argument/*S*/],>/*E*/
	SLICE_PTR var8;	// &[&str]
	SLICE_PTR var9;	// &[::"core-0_0_0"::fmt::ArgumentV1/*S*/]
	var0 = 0x0ull;	// _0 = Constant(0x0 usize)
	var1 = & var0;	// _1 = Borrow(Shared, _0)
	var8 = make_sliceptr(&ZRG2cD3binB_09FRAGMENTS0g.val, 0x2ull);	// _8 = MakeDst(&::"bin#"::#0::FRAGMENTS, 0x2 usize)
	var2 = ZRIG2cE9core0_0_03fmt10ArgumentV10g3new1gCu( var1, ZRQCu2cE9core0_0_03fmt7Display0g_B0g );
	// ^ Call( _2 = <::"core-0_0_0"::fmt::ArgumentV1/*S*/ /*- */>::new<usize,>( _1, &<usize as ::"core-0_0_0"::fmt::Display>::fmt, ), bb1, bb3)
	var3.DATA[0] = var2;	// _3 = Array(_2)
	var4 = & var3;	// _4 = Borrow(Shared, _3)
	var9 = make_sliceptr(var4, 0x1ull);	// _9 = MakeDst(_4, 0x1 usize)
	memset(&var7, 0, sizeof(struct e_ZRG2cE9core0_0_06option6Option1gBsSG4c_A3fmt2rt2v18Argument0g ));	// _7 = Variant(::"core-0_0_0"::option::Option<&[::"core-0_0_0"::fmt::rt::v1::Argument/*S*/],> #0, {})
	var6._0 = var8;
	var6._1 = var7;
	var6._2 = var9;	// _6 = Struct(::"core-0_0_0"::fmt::Arguments, {_8, _7, _9})
	ZRG3cD8std0_0_02io5stdio6_print0g( var6 );
	// ^ Call( _5 = ::"std-0_0_0"::io::stdio::_print( _6, ), bb2, bb3)
	/* ZST assign */
	return ;
	// ^ Return
