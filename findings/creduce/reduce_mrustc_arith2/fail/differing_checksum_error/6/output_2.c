...
void  ZRG1cD3bin4main0g(void)
{
	...
	int128_t var0;	// i128
	int128_t *var1;	// &i128
	struct s_ZRG2cE9core0_0_03fmt10ArgumentV10g var2;	// ::"core-0_0_0"::fmt::ArgumentV1/*S*/
	t_ZRTA1G2cE9core0_0_03fmt10ArgumentV10g var3;	// [::"core-0_0_0"::fmt::ArgumentV1/*S*/; 1]
	t_ZRTA1G2cE9core0_0_03fmt10ArgumentV10g *var4;	// &[::"core-0_0_0"::fmt::ArgumentV1/*S*/; 1]
	tUNIT var5 = {0};	// ()
	TUP_2_ZRTCj_ZRTCw var6;	// (i128, bool, )
	struct s_ZRG2cE9core0_0_03fmt9Arguments0g var7;	// ::"core-0_0_0"::fmt::Arguments/*S*/
	struct e_ZRG2cE9core0_0_06option6Option1gBsSG4c_A3fmt2rt2v18Argument0g var8;	// ::"core-0_0_0"::option::Option<&[::"core-0_0_0"::fmt::rt::v1::Argument/*S*/],>/*E*/
	SLICE_PTR var9;	// &[&str]
	SLICE_PTR var10;	// &[::"core-0_0_0"::fmt::ArgumentV1/*S*/]
	var6 = ZRICj15overflowing_div0g( make128s_raw(14351359804672997278ull, 9534762524487155391ull), make128s_raw(0ull, 4ull) );
	// ^ Call( _6 = <i128 /*- */>::overflowing_div( -75546505494413382671545042043112554817 i128, +4 i128, ), bb1, bb4)
	var0 = var6._0;	// _0 = Use(_6.0)
	var1 = & var0;	// _1 = Borrow(Shared, _0)
	var9 = make_sliceptr(&ZRG2cD3binB_09FRAGMENTS0g.val, 0x2ull);	// _9 = MakeDst(&::"bin#"::#0::FRAGMENTS, 0x2 usize)
	var2 = ZRIG2cE9core0_0_03fmt10ArgumentV10g3new1gCj( var1, ZRQCj2cE9core0_0_03fmt7Display0g_B0g );
	// ^ Call( _2 = <::"core-0_0_0"::fmt::ArgumentV1/*S*/ /*- */>::new<i128,>( _1, &<i128 as ::"core-0_0_0"::fmt::Display>::fmt, ), bb2, bb4)
	var3.DATA[0] = var2;	// _3 = Array(_2)
	var4 = & var3;	// _4 = Borrow(Shared, _3)
	var10 = make_sliceptr(var4, 0x1ull);	// _10 = MakeDst(_4, 0x1 usize)
	memset(&var8, 0, sizeof(struct e_ZRG2cE9core0_0_06option6Option1gBsSG4c_A3fmt2rt2v18Argument0g ));	// _8 = Variant(::"core-0_0_0"::option::Option<&[::"core-0_0_0"::fmt::rt::v1::Argument/*S*/],> #0, {})
	var7._0 = var9;
	var7._1 = var8;
	var7._2 = var10;	// _7 = Struct(::"core-0_0_0"::fmt::Arguments, {_9, _8, _10})
	ZRG3cD8std0_0_02io5stdio6_print0g( var7 );
	// ^ Call( _5 = ::"std-0_0_0"::io::stdio::_print( _7, ), bb3, bb4)
	/* ZST assign */
	return ;
	// ^ Return
