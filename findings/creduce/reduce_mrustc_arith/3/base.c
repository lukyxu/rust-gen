...
void  ZRG1cD3bin4main0g(void)
{
	...
	int32_t var2;	// i32
	var2 = 6;	// _2 = Constant(+6 i32)
	var0 = ZRICf15overflowing_div0g( 1495423857, 13684 );
	// ^ Call( _0 = <i32 /*- */>::overflowing_div( +1495423857 i32, +13684 i32, ), bb1, bb3)
	var1 = ZRICf15overflowing_rem0g( var2, var0._0 );
	// ^ Call( _1 = <i32 /*- */>::overflowing_rem( _2, _0.0, ), bb2, bb3)
	/* ZST assign */
	return ;
	// ^ Return
