...
void  ZRG1cD3bin4main0g(void)
{
	tUNIT rv;
	int32_t var0;	// i32
	struct s_ZRG2cE9core0_0_03fmt10ArgumentV10g var1;	// ::"core-0_0_0"::fmt::ArgumentV1/*S*/
	t_ZRTA1G2cE9core0_0_03fmt10ArgumentV10g var2;	// [::"core-0_0_0"::fmt::ArgumentV1/*S*/; 1]
	...
	var1 = ZRIG2cE9core0_0_03fmt10ArgumentV10g3new1gCf( var5, ZRQCf2cE9core0_0_03fmt7Display0g_B0g );
	// ^ Call( _1 = <::"core-0_0_0"::fmt::ArgumentV1/*S*/ /*- */>::new<i32,>( _5, &<i32 as ::"core-0_0_0"::fmt::Display>::fmt, ), bb1, bb3)
	var2.DATA[0] = var1;	// _2 = Array(_1)
	var3 = & var2;	// _3 = Borrow(Shared, _2)
	var9 = make_sliceptr(var3, 0x1ull);	// _9 = MakeDst(_3, 0x1 usize)
	...
	// ^ Call( _4 = ::"std-0_0_0"::io::stdio::_print( _6, ), bb2, bb3)
	/* ZST assign */
	return ;
	// ^ Return
